...
from .model import XCapFusionNoLabel, ConvAggregator
...
def predict(dataset):
    ...
    real_captions = []
    FOLDER_NAMES=[]
    predictor = NoLabelPredictor(config_path)
...
class NoLabelPredictor:
    def __init__(self, config_path):
        ...
        self.model = XCapFusionNoLabel(self.prefix_length, clip_length=prefix_length_clip, prefix_size=prefix_dim,
